...
fn bench_liquidity_pool_swap(b: &mut Bencher) {
    ...
    pool.add_liquidity("user1".to_string(), 1000000.0, 1000000.0, 30).expect("Failed to add liquidity");
...
fn bench_cross_chain_message_creation(b: &mut Bencher) {
    ...
    b.iter(|| {
        let message = protocol.create_cross_chain_message(
            "chain_a".to_string(),
            "chain_b".to_string(),
            "user1".to_string(),
            "user2".to_string(),
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("post_quantum_keypair_generation", bench_post_quantum_keypair_generation);
    ...
    c.bench_function("threshold_signature_key_generation", bench_threshold_signature_key_generation);
    c.bench_function("threshold_signature_partial_generation", bench_threshold_signature_partial_generation);
    c.bench_function("threshold_signature_combination", bench_threshold_signature_combination);
    ...
    c.bench_function("cross_chain_message_creation", bench_cross_chain_message_creation);
}
