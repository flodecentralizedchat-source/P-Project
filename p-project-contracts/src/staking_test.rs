...
mod tests {
    ...
    fn test_projected_rewards_calculation() {
        ...
        let projected_rewards = staking_contract.calculate_projected_rewards(amount, duration_days, None);
        
        println!("Projected rewards for 1000 tokens over 1 year: {}", projected_rewards);
        ...
        let projected_rewards_with_tier = staking_contract.calculate_projected_rewards(
            amount, 
            duration_days, 
            Some("Gold")
        );
        
        println!("Projected rewards for 1000 tokens over 1 year at 20% APY: {}", projected_rewards_with_tier);
    ...
    fn test_projected_rewards_with_different_durations() {
        ...
        println!("Projected rewards for 1000 tokens over 30 days: {}", rewards_30_days);
        ...
        println!("Projected rewards for 1000 tokens over 90 days: {}", rewards_90_days);
    ...
    fn test_projected_rewards_with_tier_selection() {
        ...
        let rewards_auto_tier = staking_contract.calculate_projected_rewards(amount, duration_days, None);
        
        // With explicitly specifying Silver tier
        let rewards_silver_tier = staking_contract.calculate_projected_rewards(
            amount, 
            duration_days, 
            Some("Silver")
        );
        ...
        let rewards_basic_tier = staking_contract.calculate_projected_rewards(
            amount, 
            duration_days, 
            Some("Basic")
        );
