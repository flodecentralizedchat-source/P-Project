...
fn test_private_investor_vesting_schedule() {
    ...
    let result =
        vesting_contract.create_private_investor_vesting(user_id.clone(), amount, start_date);
    assert!(result.is_ok());
...
fn test_multiple_investor_types() {
    ...
    let seed_schedule = vesting_contract
        .get_vesting_schedule("seed_investor")
        .unwrap();
    ...
    let private_schedule = vesting_contract
        .get_vesting_schedule("private_investor")
        .unwrap();
    ...
    let public_schedule = vesting_contract
        .get_vesting_schedule("public_sale_investor")
        .unwrap();
