...
impl AirdropContract {
    ...
    pub fn new_timed(total_amount: f64, start_time: NaiveDateTime, end_time: NaiveDateTime) -> Self {
        Self {
            airdrop_id: generate_id(),
            total_amount,
            distributed_amount: 0.0,
    ...
    pub fn add_recipients_with_category(&mut self, recipients: Vec<(String, f64)>, category: Option<String>) -> Result<(), String> {
    ...
    pub fn set_merkle_proof(&mut self, user_id: &str, proof: String) {
