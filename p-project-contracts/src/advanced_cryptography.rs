...
pub mod post_quantum {
    ...
    pub fn encrypt(
        _public_key: &[u8],
        data: &[u8],
    ) -> Result<PQEncryptedData, Box<dyn std::error::Error>> {
    ...
    pub fn decrypt(
        _private_key: &[u8],
        encrypted_data: &PQEncryptedData,
...
pub mod threshold_signatures {
    ...
    ) -> Result<Vec<Participant>, Box<dyn std::error::Error>> {
    ...
    ) -> Result<ThresholdSignature, Box<dyn std::error::Error>> {
    ...
    pub fn verify_signature(
        ...
        _message: &[u8],
        _scheme: &ThresholdSignatureScheme,
    ) -> Result<bool, Box<dyn std::error::Error>> {
